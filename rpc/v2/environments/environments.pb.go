...
func (x *DeleteBranchEnvironmentRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
const file_environments_proto_rawDesc = "" +
	...
	"\x0fDeleteNamespace\x12$.environments.DeleteNamespaceRequest\x1a%.environments.DeleteNamespaceResponse\"S\xbaG\x11*\x0fdeleteNamespace\x82\xd3\xe4\x93\x029*7/api/v2/environments/{environment_key}/namespaces/{key}\x12\xc5\x01\n" +
	"\vGetResource\x12 .environments.GetResourceRequest\x1a\x1e.environments.ResourceResponse\"t\xbaG\r*\vgetResource\x82\xd3\xe4\x93\x02^\x12\\/api/v2/environments/{environment_key}/namespaces/{namespace_key}/resources/{type_url}/{key}\x12\xca\x01\n" +
