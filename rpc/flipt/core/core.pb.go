...
const file_core_core_proto_rawDesc = "" +
	...
	"flipt.core\x1a\x1cgoogle/protobuf/struct.proto\"\xb9\x03\n" +
	"\x04Flag\x12\x10\n" +
	...
	"\bmetadata\x18\n" +
	" \x01(\v2\x17.google.protobuf.StructH\x01R\bmetadata\x88\x01\x01\x12\x12\n" +
	"\x04tags\x18\v \x03(\tR\x04tagsB\x12\n" +
