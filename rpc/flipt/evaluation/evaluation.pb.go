...
type BooleanEvaluationResponse struct {
	...
	SegmentKeys           []string               `protobuf:"bytes,7,rep,name=segment_keys,json=segmentKeys,proto3" json:"segment_keys,omitempty"`
	unknownFields         protoimpl.UnknownFields
	sizeCache             protoimpl.SizeCache
}
...
func (x *BooleanEvaluationResponse) GetSegmentKeys() []string {
	if x != nil {
...
const file_evaluation_evaluation_proto_rawDesc = "" +
	"\n" +
	"\x1bevaluation/evaluation.proto\x12\x10flipt.evaluation\x1a$gnostic/openapi/v3/annotations.proto\x1a\x1cgoogle/api/annotations.proto\x1a\x1fgoogle/api/field_behavior.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\xf7\x02\n" +
	...
	"\bflag_key\x18\x06 \x01(\tR\aflagKey\x12!\n" +
	"\fsegment_keys\x18\a \x03(\tR\vsegmentKeys\"\x8c\x03\n" +
